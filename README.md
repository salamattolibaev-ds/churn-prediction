...
|-----------|----------|----------------|-----------|----------|----------|
| CatBoost  | 0.889    | 0.671          | 0.921     | 0.682    | 0.782    |
| GB        | 0.888    | 0.479          | 0.977     | 0.717    | 0.826    |
| RF        | 0.881    | 0.381          | 0.957     | 0.726    | 0.824    |
| XGBoost   | 0.878    | 0.631          | 0.980     | 0.715    | 0.826    |
| LightGBM  | 0.867    | 0.811          | 0.992     | 0.718    | 0.831    |
| LogReg    | 0.722    | 0.575          | 0.329     | 0.560    | 0.404    |

## Бизнес-рекомендации на основе модели

Ценовая политика: Основной драйвер оттока — суммарные начисления (total_charge). Компании стоит пересмотреть тарифы для активных пользователей, чтобы их траты не превышали психологический порог.

Работа с жалобами: Каждый звонок в customer_service_calls экспоненциально увеличивает риск ухода. Необходимо внедрить систему "быстрого реагирования" на клиентов, совершивших более 3 звонков.

Региональное развитие: Высокая важность state_te указывает на технические проблемы или высокую активность конкурентов в определенных штатах. Требуется локальный аудит сети.
